...
return <div className="bg-background-main h-screen w-screen">
    ...
    <div className="px-2 md:p-4 grid grid-cols-3 gap-2 md:grid-cols-4 md:gap-2">
        <ShopCart image={"https://img.freepik.com/free-vector/shop-with-sign-we-are-open_52683-38687.jpg"} name="Dilliram Adhikari Tsongkhang" locaton="tsirang" type="Grocery" contact="77830649"
         ...
         <ShopCart image={"https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2d/c6/75/6e/must-visit-for-great.jpg?w=1200&h=1200&s=1"} type="Hardware"  name="Dorji Tsongkhang" locaton="tsirang" contact="77830649"
         button={<Button title="View Shop" variant="primary" size="sm" font="normal" fullWidth={true} click={()=>{alert("hello")}}/>}/>
